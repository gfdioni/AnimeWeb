<head>
    ...
    <title>Admin Control Panel | <?php echo $title; ?></title>
	...
	<link rel="stylesheet" href="<?php echo $assets; ?>plugins/select2/select2.css">
	<!-- DataTables -->
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo $assets; ?>plugins/iCheck/flat/blue.css">
    <!-- Morris chart -->
    <link rel="stylesheet" href="<?php echo $assets; ?>plugins/morris/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="<?php echo $assets; ?>plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="<?php echo $assets; ?>plugins/datepicker/datepicker3.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?php echo $assets; ?>plugins/daterangepicker/daterangepicker-bs3.css">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo $assets; ?>dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo $assets; ?>dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Developers
